# Python–tensorflow . math . unsorted _ segment _ prod()

> 原文:[https://www . geesforgeks . org/python-tensorflow-math-unsorted _ segment _ prod/](https://www.geeksforgeeks.org/python-tensorflow-math-unsorted_segment_prod/)

TensorFlow 是谷歌设计的开源 Python 库，用于开发机器学习模型和深度学习神经网络。

**unsorted_segment_prod()** 用于查找各段的乘积。

> **语法:**tensorflow . math . unsorted _ segment _ prod(数据，segment_ids，num_segments，名称)
> 
> **参数:**
> 
