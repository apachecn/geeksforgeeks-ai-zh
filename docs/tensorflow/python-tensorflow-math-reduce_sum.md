# Python–tensorflow . math . reduce _ sum()

> 原文:[https://www . geesforgeks . org/python-tensorflow-math-reduce _ sum/](https://www.geeksforgeeks.org/python-tensorflow-math-reduce_sum/)

TensorFlow 是谷歌设计的开源 Python 库，用于开发机器学习模型和深度学习神经网络。

**reduce_sum()** 用于求张量各维元素的和。

> **语法:**tensorflow . math . reduce _ sum(input _ tensor，axis，keepdims，name)
> 
> **参数:**
> 
