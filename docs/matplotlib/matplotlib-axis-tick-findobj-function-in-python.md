...
> 原文:[https://www . geesforgeks . org/matplotlib-axis-tick-find obj-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/)

[**Matplotlib**](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 NumPy 库的数值-数学扩展。这是一个神奇的 Python 可视化库，用于 2D 数组图，并用于处理更广泛的 SciPy 堆栈。

## Matplotlib.axis.Tick.findobj()函数

matplotlib 库的轴模块中的 **Tick.findobj()函数**用于查找艺术家对象。

> **语法:** Tick.findobj(self，match=None，include_self=True)
> 
> **参数:**该方法接受以下参数。
> 
...
下面的例子说明了 matplotlib.axis.Tick.findobj()函数在 matplotlib.axis:
中的作用
